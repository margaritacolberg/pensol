...
# get_error_s_bias.py can be carried out either on a local computer, or on a
# computer cluster
#
# example of how to run:
# python ../../tools/get_error_s_bias.py hybridmc_4_0100101100_1100101100.json ../../../hybridmc/release/hybridmc --hdf5 hybridmc_3_0000101100_0100101100.h5 5
#
# note that the hybridmc dir must be downloaded and compiled before
# get_error_s_bias.py is run
